...
const Footer = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_y0plzht', 'template_p6xnmke', form.current, {
                publicKey: 'Obr0GfxNtbgmAkuoF',
            })
            .then(
                () => {
                    setSuccessMessage('Thank you for contacting us!'); // Set the success message
                },
                (error) => {
                ...
                <div className="mx-auto w-full max-w-screen-xl">
                    <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="https://x.com/emmamattress" className="hover:underline">Twitter</a>
                                </li>
                                <li className="mb-4">
                                    <a href="https://www.facebook.com/EmmaMattressIndia/" className="hover:underline">Facebook</a>
                                </li>
                                <li className="mb-4">
                                    <div>
                                        ...
                                        <div
                                            id="drawer-contact"
                                            className={`fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform bg-white w-80 dark:bg-gray-800 ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}
                                            tabIndex="-1"
